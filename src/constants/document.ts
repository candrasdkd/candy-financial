...
export const CATEGORY_INFO: Record<DocCategory, { label: string; emoji: string; color: string }> = {
  ...
  transkrip: { label: 'Transkrip Nilai', emoji: '📑', color: 'bg-indigo-50 text-indigo-700 border-indigo-100' },
...
export const FIELD_TEMPLATES: Record<DocCategory, string[]> = {
  ...
  transkrip: ['Nama', 'NIM/NPM', 'Sekolah/Universitas', 'Program Studi', 'IPK'],
